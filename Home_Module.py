...
try:
    ...
    if err.errno == mysql.connector.errorcode.ER_BAD_DB_ERROR:
            ...
            VALUES
            (1, 'Single Room', '101', 100, 'Available', 'Good', 2, 'Wi-Fi, TV', 'Male'),
            (2, 'Twin Room', '201', 150, 'Occupied', 'Excellent', 3, 'Wi-Fi, TV, Mini Bar', 'Female'),
            (3, 'Premium Room', '301', 250, 'Available', 'Excellent', 4, 'Wi-Fi, TV, Jacuzzi', 'Male'),
            (4, 'Single Room', '102', 110, 'Available', 'Good', 2, 'Wi-Fi, TV', 'Female'),
            (5, 'Twin Room', '202', 160, 'Occupied', 'Excellent', 3, 'Wi-Fi, TV, Mini Bar', 'Male'),
            (6, 'Premium Room', '302', 270, 'Available', 'Excellent', 4, 'Wi-Fi, TV, Jacuzzi', 'Female'),
            (7, 'Single Room', '103', 120, 'Available', 'Good', 2, 'Wi-Fi, TV', 'Male'),
            (8, 'Twin Room', '203', 170, 'Occupied', 'Excellent', 3, 'Wi-Fi, TV, Mini Bar', 'Male'),
            (9, 'Premium Room', '303', 280, 'Available', 'Excellent', 4, 'Wi-Fi, TV, Jacuzzi', 'Female'),
            (10, 'Single Room', '104', 130, 'Available', 'Good', 2, 'Wi-Fi, TV', 'Female'),
            (11, 'Twin Room', '204', 180, 'Occupied', 'Excellent', 3, 'Wi-Fi, TV, Mini Bar', 'Male'),
            (12, 'Premium Room', '304', 290, 'Available', 'Excellent', 4, 'Wi-Fi, TV, Jacuzzi', 'Female'),
            (13, 'Single Room', '105', 140, 'Available', 'Good', 2, 'Wi-Fi, TV', 'Male'),
            (14, 'Twin Room', '205', 190, 'Occupied', 'Excellent', 3, 'Wi-Fi, TV, Mini Bar', 'Male'),
            (15, 'Premium Room', '305', 300, 'Available', 'Excellent', 4, 'Wi-Fi, TV, Jacuzzi', 'Female'),
            (16, 'Single Room', '106', 150, 'Available', 'Good', 2, 'Wi-Fi, TV', 'Female'),
            (17, 'Twin Room', '206', 200, 'Occupied', 'Excellent', 3, 'Wi-Fi, TV, Mini Bar', 'Male'),
            (18, 'Suite', '306', 310, 'Available', 'Excellent', 4, 'Wi-Fi, TV, Jacuzzi', 'Female'),
            (19, 'Standard', '107', 160, 'Available', 'Good', 2, 'Wi-Fi, TV', 'Male'),
            (20, 'Twin Room', '207', 210, 'Occupied', 'Excellent', 3, 'Wi-Fi, TV, Mini Bar', 'Male'),
            (21, 'Premium Room', '307', 320, 'Available', 'Excellent', 4, 'Wi-Fi, TV, Jacuzzi', 'Female'),
            (22, 'Single Room', '108', 170, 'Available', 'Good', 2, 'Wi-Fi, TV', 'Female'),
            (23, 'Twin Room', '208', 220, 'Occupied', 'Excellent', 3, 'Wi-Fi, TV, Mini Bar', 'Male');
            """)
            mydb.commit()

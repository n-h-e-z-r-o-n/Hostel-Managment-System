...
total_Resident_frame = tk.Frame(Hostel_Status_frame)
...
total_Resident_lable2 = tk.Label(total_Resident_frame, text=f"{total_number_of_resident}", anchor='center',
                                 fg='#704214', font='-family {Courier New} -size 15 -weight bold -slant italic')
...
male_Resident_lable1 = tk.Label(male_Resident_frame, text="MALE RESIDENTS\n(total male residents)", anchor='center',
                                font='-family {Times New Roman} -size 8 -weight bold')
male_Resident_lable1.place(relwidth=0.6, relheight=1)
male_Resident_lable2 = tk.Label(male_Resident_frame, text=f"{total_male_resident}", anchor='center', fg='#704214',
                                font='-family {Courier New} -size 15 -weight bold -slant italic')
...
female_Resident_lable2 = tk.Label(female_Resident_frame, text=f"{total_female_resident}", anchor='center', fg='#704214',
                                  font='-family {Courier New} -size 15 -weight bold -slant italic')
female_Resident_lable2.place(relx=0.6, relwidth=0.4, relheight=1)

available_rooms_frame = tk.Frame(Hostel_Status_frame)
...
title_lable1 = tk.Label(Reserve_Room_frame, text="Student Personal Information *", anchor='w', borderwidth=0,
                        font='-family {Georgia} -size 14 -weight bold')
title_lable1.place(relx=0.05, rely=0.1, relwidth=0.31, relheight=0.04)

first_name_lable = tk.Label(Reserve_Room_frame, text="First Name", anchor='w', borderwidth=0,
...
Second_name_lable = tk.Label(Reserve_Room_frame, text="Second Name", anchor='w', borderwidth=0,
...
Last_name_lable = tk.Label(Reserve_Room_frame, text="Last Name", anchor='w', borderwidth=0,
                           font='-family {Georgia} -size 10 -weight bold')
...
Date_of_birth_lable = tk.Label(Reserve_Room_frame, text="Date Of Birth", anchor='w', borderwidth=0,
                               font='-family {Georgia} -size 10 -weight bold')
...
Gender_lable = tk.Label(Reserve_Room_frame, text="Gender", anchor='w', borderwidth=0,
                        font='-family {Georgia} -size 10 -weight bold')
...
Phone_no_lable = tk.Label(Reserve_Room_frame, text="Phone NO ", anchor='w', borderwidth=0,
                          font='-family {Georgia} -size 10 -weight bold')
...
def Search_del_student(room_num, student_name):
        ...
        if room_num == deloc_r[0][2]:
                    ...
                    tk.Label(section_2_deall, fg='red',text=f'{deloc_s[0][9]}', anchor='w', font='-family {Courier New}  -size 11 -weight bold').place(rely=0.345, relx=0.17, relwidth=0.27, relheight=0.065)
                    tk.Label(section_2_deall, fg='red',text=f'{deloc_s[0][10]}', anchor='w', font='-family {Courier New}  -size 11 -weight bold').place(rely=0.412, relx=0.17, relwidth=0.27, relheight=0.065)
                    tk.Label(section_2_deall, fg='red',text=f'{deloc_r[0][2]}', anchor='w', font='-family {Courier New}  -size 11 -weight bold').place(rely=0.479, relx=0.17, relwidth=0.27, relheight=0.065)

                    tk.Label(section_2_deall,  fg='red',text=f'{deloc_par[0][0]} {deloc_par[0][1]}', anchor='w', font='-family {Courier New}  -size 11 -weight bold').place(rely=0.01, relx=0.66, relwidth=0.27, relheight=0.065)
                    tk.Label(section_2_deall, fg='red',text=f'{deloc_par[0][2]}', anchor='w', font='-family {Courier New}  -size 11 -weight bold').place(rely=0.077, relx=0.66, relwidth=0.27, relheight=0.065)
                    tk.Label(section_2_deall, fg='red',text=f'{deloc_par[0][3]}', anchor='w', font='-family {Courier New}  -size 11 -weight bold').place(rely=0.144, relx=0.66, relwidth=0.27, relheight=0.065)
...
tk.Entry(section_1_deall,  textvariable=deallocate_room, font='-family {Georgia}  -size 11 -weight bold').place(relx=0.26, rely=0.03, relheight=0.3, relwidth=0.2)
tk.Entry(section_1_deall,  textvariable=deallocate_student, font='-family {Georgia}  -size 11 -weight bold').place(relx=0.26, rely=0.4, relheight=0.3, relwidth=0.2)
...
tk.Label(section_2_deall, text='Student Name:', anchor='e', font='-family {Cambria}  -size 11 -weight bold').place(rely=0.01, relx=0.01, relwidth=0.15, relheight=0.065)
tk.Label(section_2_deall,text='Gender:', anchor='e', font='-family {Cambria}  -size 11 -weight bold').place(rely=0.077, relx=0.01, relwidth=0.15, relheight=0.065)
tk.Label(section_2_deall, text='Date Of Birth:', anchor='e', font='-family {Cambria}  -size 11 -weight bold').place(rely=0.144, relx=0.01, relwidth=0.15, relheight=0.065)
tk.Label(section_2_deall, text='Phone No:', anchor='e', font='-family {Cambria}  -size 11 -weight bold').place(rely=0.211, relx=0.01, relwidth=0.15, relheight=0.065)
tk.Label(section_2_deall, text='Email ID:', anchor='e', font='-family {Cambria}  -size 11 -weight bold').place(rely=0.278, relx=0.01, relwidth=0.15, relheight=0.065)
tk.Label(section_2_deall, text='Institution:', anchor='e', font='-family {Cambria}  -size 11 -weight bold').place(rely=0.345, relx=0.01, relwidth=0.15, relheight=0.065)
tk.Label(section_2_deall, text='National ID:', anchor='e', font='-family {Cambria}  -size 11 -weight bold').place(rely=0.412, relx=0.01, relwidth=0.15, relheight=0.065)
tk.Label(section_2_deall, text='Room Number:', anchor='e', font='-family {Cambria}  -size 11 -weight bold').place(rely=0.479, relx=0.01, relwidth=0.15, relheight=0.065)
# parent info
tk.Label(section_2_deall, text='Parent Name:', anchor='e', font='-family {Cambria}  -size 11 -weight bold').place(rely=0.01, relx=0.5, relwidth=0.15, relheight=0.065)
tk.Label(section_2_deall, text='Parent Phone NO::', anchor='e', font='-family {Cambria}  -size 11 -weight bold').place(rely=0.077, relx=0.5, relwidth=0.15, relheight=0.065)
tk.Label(section_2_deall, text='Parent Email', anchor='e', font='-family {Cambria}  -size 11 -weight bold').place(rely=0.144, relx=0.5, relwidth=0.15, relheight=0.065)
